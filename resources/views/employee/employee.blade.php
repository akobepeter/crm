                ...
                <ul id="iq-sidebar-toggle" class="side-menu">
                    ...
                    <!-- <li class=" sidebar-layout">
                        <a href="#" class="svg-icon">
                            ...
                            </i><span class="ml-2">Add Employee</span>
                        </a>
                    </li> -->
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <div class="header-action">
                                <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target=".bd-new_employee-modal-lg">Add New</button>
                                                            ...
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    <select class="form-control mb-3">
                                                                        ...
                                                                        <option value="3">Product Maneger</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
