                ...
                <div class="board">
                    ...
                    <div class="lanes">
                        <div class="swim-lane" id="todo-lane">
                            <h3 class="headings">Tasks</h3>

                            <p class="task" draggable="true">Sign Up Page</p>
                            <p class="task" draggable="true">Log Out Form</p>
                            <p class="task" draggable="true">Password Recovery</p>
                        </div>

                        <div class="swim-lane" id="todo-lane">
                            <h3 class="headings">In Progress</h3>
                        ...
                        <div class="swim-lane" id="todo-lane">
                            <h3 class="headings">Code Review</h3>

                            <p class="task" draggable="true">Get groceries</p>
                            <p class="task" draggable="true">Create The Project UI</p>
                            <p class="task" draggable="true">Create The Tasks UI</p>


                        </div>

                        <div class="swim-lane" id="todo-lane">
                            <h3 class="headings">Testing</h3>
                        ...
                        <div class="swim-lane" id="todo-lane">
                            <h3 class="headings">Completed</h3>

                            <p class="task" draggable="true">UI/UX</p>
                            <p class="task" draggable="true">Graphics Design</p>
